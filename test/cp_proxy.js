...
test('no args', async t => {
  const result = await shell.cp();
  t.truthy(shell.error());
  t.is(result.code, 1);
  t.is(result.stderr, 'cp: missing <source> and/or <dest>');
});

test('no destination', async t => {
  const result = await shell.cp('file1');
  t.truthy(shell.error());
  t.is(result.code, 1);
  t.is(result.stderr, 'cp: missing <source> and/or <dest>');
});
...
test('invalid option', async t => {
  const result = await shell.cp('-@', 'test/resources/file1', `${t.context.tmp}/file1`);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('invalid option #2', async t => {
  const result = await shell.cp('-Z', 'asdfasdf', `${t.context.tmp}/file2`);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('source does not exist', async t => {
  const result = await shell.cp('asdfasdf', t.context.tmp);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('multiple sources do not exist', async t => {
  const result = await shell.cp('asdfasdf1', 'asdfasdf2', t.context.tmp);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('too many sources', async t => {
  const result = await shell.cp('asdfasdf1', 'asdfasdf2', 'test/resources/file1');
  t.truthy(shell.error());
  t.is(result.code, 1);
  t.is(result.stderr, 'cp: dest is not a directory (too many sources)');
});

test('too many sources #2', async t => {
  const result = await shell.cp('test/resources/file1', 'test/resources/file2', `${t.context.tmp}/a_file`);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('empty string source', async t => {
  const result = await shell.cp('', 'dest');
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('dest already exists', async t => {
  const oldContents = shell.cat('test/resources/file2').toString();
  const result = await shell.cp('-n', 'test/resources/file1', 'test/resources/file2');
  t.falsy(shell.error());
  t.is(result.code, 0);
  t.is(result.stderr, '');
...
test('-nR does not overwrite an existing file at the destination', async t => {
  // Create tmp/new/cp/a
  ...
  const result = await shell.cp('-nR', 'test/resources/cp/', `${t.context.tmp}/new/`);
  t.falsy(shell.error());
  t.is(result.code, 0);
...
test('-n does not overwrite an existing file if the destination is a directory', async t => {
  const oldContents = 'original content';
  shell.cp('test/resources/file1', `${t.context.tmp}`);
  new shell.ShellString(oldContents).to(`${t.context.tmp}/file1`);
  const result = await shell.cp('-n', 'test/resources/file1', `${t.context.tmp}`);
  t.falsy(shell.error());
  t.is(result.code, 0);
  t.falsy(result.stderr);
...
test('-f by default', async t => {
  shell.cp('test/resources/file2', 'test/resources/copyfile2');
  const result = await shell.cp('test/resources/file1', 'test/resources/file2'); // dest already exists
  t.falsy(shell.error());
  t.is(result.code, 0);
  t.falsy(result.stderr);
...
test('-f (explicitly)', async t => {
  shell.cp('test/resources/file2', 'test/resources/copyfile2');
  const result = await shell.cp('-f', 'test/resources/file1', 'test/resources/file2'); // dest already exists
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.is(shell.cat('test/resources/file1').toString(), shell.cat('test/resources/file2').toString()); // after cp
...
test('simple - to dir', async t => {
  const result = await shell.cp('test/resources/file1', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test('simple - to file', async t => {
  const result = await shell.cp('test/resources/file2', `${t.context.tmp}/file2`);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test('simple - file list', async t => {
  const result = await shell.cp('test/resources/file1', 'test/resources/file2', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.truthy(fs.existsSync(`${t.context.tmp}/file1`));
...
test('simple - file list, array syntax', async t => {
  const result = await shell.cp(['test/resources/file1', 'test/resources/file2'], t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test('-f option', async t => {
  shell.cp('test/resources/file2', `${t.context.tmp}/file3`);
  t.truthy(fs.existsSync(`${t.context.tmp}/file3`));
  const result = await shell.cp('-f', 'test/resources/file2', `${t.context.tmp}/file3`); // file exists, but -f specified
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.truthy(fs.existsSync(`${t.context.tmp}/file3`));
...
test('glob', async t => {
  const result = await shell.cp('test/resources/file?', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.truthy(fs.existsSync(`${t.context.tmp}/file1`));
...
test('recursive, with regular files', async t => {
  const result = await shell.cp('-R', 'test/resources/file1', 'test/resources/file2', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.truthy(fs.existsSync(`${t.context.tmp}/file1`));
...
test('omit directory if missing recursive flag', async t => {
  const result = await shell.cp('test/resources/cp', t.context.tmp);
...
test('recursive, nothing exists', async t => {
  const result = await shell.cp('-R', 'test/resources/cp', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test('recursive, nothing exists, source ends in "/"', async t => {
  // Github issue #15
  const result = await shell.cp('-R', 'test/resources/cp/', `${t.context.tmp}/`);
  t.falsy(shell.error());
  t.falsy(result.stderr);
...
test('recursive, globbing regular files with extension', async t => {
  // Github issue #376
  const result = await shell.cp('-R', 'test/resources/file*.txt', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.truthy(fs.existsSync(`${t.context.tmp}/file1.txt`));
...
test('recursive, copying one regular file', async t => {
  // Github issue #376
  const result = await shell.cp('-R', 'test/resources/file1.txt', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
  t.truthy(fs.existsSync(`${t.context.tmp}/file1.txt`));
...
test('recursive, everything exists, no force flag', async t => {
  const result = await shell.cp('-R', 'test/resources/cp', t.context.tmp);
...
test('-R implies to not follow links', async t => {
  await utils.skipOnWin(t, async () => {
    ...
    const result = await shell.cp('-R', `${t.context.tmp}/links/*`, `${t.context.tmp}/fakeLinks`);
    t.falsy(shell.error());
    t.falsy(result.stderr);
    t.is(result.code, 0);
    t.truthy(common.statNoFollowLinks(`${t.context.tmp}/links/sym.lnk`).isSymbolicLink()); // this one is a link
...
test('Missing -R implies -L', async t => {
  await utils.skipOnWin(t, async () => {
    ...
    const result = await shell.cp(`${t.context.tmp}/links/*`, `${t.context.tmp}/fakeLinks`); // don't use -R
    t.falsy(shell.error());
    t.falsy(result.stderr);
    t.is(result.code, 0);
    t.truthy(common.statNoFollowLinks(`${t.context.tmp}/links/sym.lnk`).isSymbolicLink()); // this one is a link
...
test('recursive, everything exists, with force flag', async t => {
  let result = await shell.cp('-R', 'test/resources/cp', t.context.tmp);
  ...
  result = await shell.cp('-Rf', 'test/resources/cp', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test("recursive, creates dest dir since it's only one level deep", async t => {
  // Github issue #44
  const result = await shell.cp('-r', 'test/resources/issue44', `${t.context.tmp}/dir2`);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test("recursive, does *not* create dest dir since it's too deep", async t => {
  // Github issue #44
  const result = await shell.cp('-r', 'test/resources/issue44', `${t.context.tmp}/dir2/dir3`);
  t.truthy(shell.error());
  t.is(
    result.stderr,
...
test('recursive, copies entire directory', async t => {
  const result = await shell.cp('-r', 'test/resources/cp/dir_a', `${t.context.tmp}/dest`);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test('recursive, with trailing slash, does the exact same', async t => {
  const result = await shell.cp('-r', 'test/resources/cp/dir_a/', `${t.context.tmp}/dest`);
  t.is(result.code, 0);
  t.falsy(shell.error());
  t.truthy(fs.existsSync(`${t.context.tmp}/dest/z`));
...
test('preserve mode bits by default for file', async t => {
  await utils.skipOnWin(t, async () => {
...
test('Make sure hidden files are copied recursively', async t => {
  shell.rm('-rf', t.context.tmp);
  const result = await shell.cp('-r', 'test/resources/ls/', t.context.tmp);
  t.falsy(shell.error());
  t.falsy(result.stderr);
  t.is(result.code, 0);
...
test('no-recursive will copy regular files only', async t => {
  const result = await shell.cp(
...
test('-Ru respects the -u flag recursively (don\'t update newer file)', async t => {
  // Setup code
...
test('-Ru respects the -u flag recursively (update older file)', async t => {
  // Setup code
  const dir = `${t.context.tmp}/cp-Ru`;
  const sourceDir = `${dir}/original`;
  const sourceFile = `${sourceDir}/file`;
...
test('using -P explicitly works', async t => {
  await utils.skipOnWin(t, async () => {
...
test('using -PR on a link to a folder does not follow the link', async t => {
  await utils.skipOnWin(t, async () => {
...
test('-L overrides -P for copying directory', async t => {
  await utils.skipOnWin(t, async () => {
...
test('Recursive, copies entire directory with no symlinks and -L option does not cause change in behavior', async t => {
  await utils.skipOnWin(t, async () => {
    const result = await shell.cp('-rL', 'test/resources/cp/dir_a', `${t.context.tmp}/dest`);
    t.falsy(shell.error());
    t.falsy(result.stderr);
    t.is(result.code, 0);
    t.truthy(fs.existsSync(`${t.context.tmp}/dest/z`));
...
test('-u flag won\'t overwrite newer files', async t => {
...
test('-u flag does overwrite older files', async t => {
...
test('-u flag works even if it\'s not overwriting a file', async t => {
  t.falsy(fs.existsSync(`${t.context.tmp}/file1.js`));
  shell.cp('-u', 'test/resources/file1.js', t.context.tmp);
  t.falsy(shell.error());
  t.is(shell.cat('test/resources/file1.js').toString(), shell.cat(`${t.context.tmp}/file1.js`).toString());
...
test('-u flag works correctly recursively', async t => {
...
test('using -R on a link to a folder *does* follow the link', async t => {
  shell.cp('-R', 'test/resources/cp/symFolder', t.context.tmp);
  t.falsy(common.statNoFollowLinks(`${t.context.tmp}/symFolder`).isSymbolicLink());
});

test('Without -R, -L is implied', async t => {
...
test('-L explicitly works', async t => {
  shell.cp('-L', 'test/resources/cp/links/sym.lnk', t.context.tmp);
  t.falsy(common.statNoFollowLinks(`${t.context.tmp}/sym.lnk`).isSymbolicLink());
});

test('using -LR does not imply -P', async t => {
  shell.cp('-LR', 'test/resources/cp/links/sym.lnk', t.context.tmp);
  t.falsy(common.statNoFollowLinks(`${t.context.tmp}/sym.lnk`).isSymbolicLink());
});

test('using -LR also works recursively on directories containing links', async t => {
...
test('-L always overrides a -P', async t => {
...
test('Make sure max depth does not limit shallow directory structures', async t => {
...
test('cp -L follows symlinks', async t => {
  utils.skipOnWinForEPERM(shell.ln.bind(shell, '-s', `${t.context.tmp}/0`, `${t.context.tmp}/symlinktest`), () => {
...
test('Test with recursive option and symlinks.', async t => {
  utils.skipOnWinForEPERM(shell.ln.bind(shell, '-s', `${t.context.tmp}/0`, `${t.context.tmp}/symlinktest`), () => {
...
test('recursive, with a non-normalized path', async t => {
  const result = await shell.cp('-R', 'test/resources/../resources/./cp', t.context.tmp);
  t.falsy(shell.error()); // crash test only
  t.falsy(result.stderr);
  t.is(result.code, 0);
});

test('copy file to same path', async t => {
  const result = await shell.cp('test/resources/file1', 'test/resources/file1');
  t.truthy(shell.error());
  t.is(result.code, 1);
  t.is(result.stderr, "cp: 'test/resources/file1' and 'test/resources/file1' are the same file");
});

test('copy file to same directory', async t => {
  const result = await shell.cp('test/resources/file1', 'test/resources');
  t.truthy(shell.error());
  t.is(result.code, 1);
  t.is(result.stderr, "cp: 'test/resources/file1' and 'test/resources/file1' are the same file");
});

test('copy mutliple files to same location', async t => {
  const result = await shell.cp('test/resources/file1', 'test/resources/file2', 'test/resources');
  t.truthy(shell.error());
  t.is(result.code, 1);
  t.is(
    result.stderr,
...
test('should not overwrite recently created files', async t => {
  const result = await shell.cp('test/resources/file1', 'test/resources/cp/file1', t.context.tmp);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('should not overwrite recently created files (in recursive Mode)', async t => {
  const result = await shell.cp('-R', 'test/resources/file1', 'test/resources/cp/file1', t.context.tmp);
  t.truthy(shell.error());
  t.is(result.code, 1);
...
test('should not overwrite recently created files (not give error no-force mode)', async t => {
  const result = await shell.cp('-n', 'test/resources/file1', 'test/resources/cp/file1', t.context.tmp);
  t.falsy(shell.error());
  t.is(result.code, 0);
...
test('cp -R should be able to copy a readonly src. issue #98; (Non window platforms only)', async t => {
  await utils.skipOnWin(t, async () => {
    shell.cp('-r', 'test/resources/cp', t.context.tmp);
    ...
    const result = await shell.cp('-r', `${t.context.tmp}/cp`, `${t.context.tmp}/cp_cp`);
    t.falsy(shell.error());
    t.falsy(result.stderr);
    t.is(result.code, 0);
...
test('cp -p should preserve mode, ownership, and timestamp (regular file)', async t => {
  ...
  const result = await shell.cp('-p', srcFile, `${t.context.tmp}/preservedFile1`);
...
test('cp -p should preserve mode, ownership, and timestamp (directory)', async t => {
  // Setup: copy to srcFile and modify mode and timestamp
  ...
  const result = await shell.cp('-pr', srcDir, `${t.context.tmp}/preservedDir`);
  const stat = common.statFollowLinks(srcFile);
...
test('cp -p should preserve mode, ownership, and timestamp (symlink)', async t => {
  ...
  await utils.skipOnWin(t, async () => {
    ...
    // Now re-copy with '-p' and verify metadata.
    const result = await shell.cp('-p', srcLink, `${t.context.tmp}/preservedLink`);
