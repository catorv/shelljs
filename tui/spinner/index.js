...
const cliCursor = require('../cursor.js');
const cliSpinners = require('./spinners.js');
const logSymbols = require('../utils/log-symbols.js');
const stripAnsi = require('strip-ansi');
const wcwidth = require('wcwidth');
const isInteractive = require('../utils/is-interactive.js');
const isUnicodeSupported = require('../utils/is-unicode-supported.js');
